...
/**
 * returns the result of querying for a specific person object based off an id
 */

public class PersonIDResult {
    /**
     * the datafields for either a specific person queried from the dataset
     * or a explanation for why the query failed.
     */
     ...
     * creates a new PersonID Result object
     ...
     * message will be an explanation for why it failed
     * @param success
     * @param message
     */
